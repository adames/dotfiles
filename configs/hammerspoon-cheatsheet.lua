...
local sections = {
  ...
  -- Hyper = navigate · Meh (Caps+Shift) = modify.
  {
    ...
    rows  = {
      ...
      { "caps + 1…9",                 "focus space N  (1–5 typically display 1; 6–9 display 2)" },
      { "caps + shift + 1…9",         "send window to space N (and follow)" },
      ...
      { "caps + t · n",               "new yabai-tiled terminal window  (tmux for in-window splits)" },
  ...
  -- ── Tmux ──────────────────────────────────────────────────────────────────
  {
    ...
    rows  = {
      ...
      { "C-space  x",          "kill pane  (no confirmation)" },
      { "C-space  &",          "kill window  (no confirmation)" },
